...
import type { SpecHeroData } from '@/types/spec'

interface Props {
  data: SpecHeroData
}

export default function SpecHero({ data }: Props) {
  return (
    <section
      aria-labelledby="spec-hero-heading"
    ...
    >
      ...
      <div className="relative z-10 w-full px-4 py-12 sm:px-8 sm:py-14 lg:py-[80px] lg:w-[980px] lg:mx-auto">
        ...
        <nav aria-label="Breadcrumb" className="mb-5 flex items-center gap-1.5 font-['Nunito_Sans',sans-serif] text-[0.75rem]">
          ...
          <span className="font-bold text-white">{data.pageLabel}</span>
        </nav>

        {/* 2-col sm+; stacked mobile */}
